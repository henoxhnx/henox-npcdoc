...
QBCore.Functions.CreateCallback('henox-npcdoc:docOnline', function(source, cb)
	local src = source
...
RegisterServerEvent('henox-npcdoc:charge')
AddEventHandler('henox-npcdoc:charge', function()
	local src = source
